...
const STRATEGY_META: Record<string, { label: string; color: string; description: string; holds: string; signal: string }> = {
  ...
  earnings_drift: {
    label: "Earnings Drift",
    color: "#f97316",
    description: "Buys stocks that beat EPS estimates by 5%+. Rides the post-earnings drift window — stocks that surprise tend to keep drifting up for 2–3 weeks.",
    holds: "~15 trading days",
    signal: "EPS beat ≥ 5% surprise within last 5 days",
  },
  sector_rotation: {
    label: "Sector Rotation",
    color: "#22d3ee",
    description: "Rotates into the top 3 S&P 500 sectors by 3-month momentum. Holds sector ETFs (XLK, XLF, etc.) and rebalances monthly — reduces single-stock risk.",
    holds: "~1 month",
    signal: "Top 3 sectors by 3-month return + above 50-day MA",
  },
};
